      ...
      <div className="flex items-start justify-between flex-col">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex flex-col items-start">
            <button className="cursor-pointer flex items-center justify-center md:gap-4 gap-2 md:py-2.5 py-1.5 rounded-3xl mb-4 bg-orangedeep hover:bg-btnClicked focus:bg-btnClicked md:w-[200px] w-[120px]">
