...
const PackageCard = ({ item }) => {
  ...
  return (
    <div className="relative w-full max-w-[550px] mx-auto  ">
      ...
      {/* Decoration */}
      <div className="absolute z-20 -left-10 -top-10">
        <Star />
      </div>

      {/* Card */}
      <div className="relative rounded-xl border bg-foundblue border-health w-full overflow-hidden transform  skew-y-[0.1deg]   skew-x-2  z-10 shadow-sm transition-all ">
        {/* Decorative Kite */}
