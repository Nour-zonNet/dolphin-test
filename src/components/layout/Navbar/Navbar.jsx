...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-1/2 transform -translate-x-1/2 w-full flex items-center justify-between pt-10 pb-4 px-4 sm:px-6 bg-white text-nowrap z-100">
      {/* Tabs Section */}
