...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-1/2 -translate-x-1/2 w-full flex flex-row items-center justify-between py-6 md:py-10 lg:py-12 px-6 md:px-18 bg-white shadow-[0px_2px_4px_rgba(192,192,192,0.25)] z-50">
      {/* Tabs Section */}
