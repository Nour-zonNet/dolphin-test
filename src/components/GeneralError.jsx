      ...
      <div className="flex flex-col items-center justify-center text-center w-full">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center w-[80%]">
          ...
          <button 
            ...
            className="bg-white border border-[#D18C2D] w-full text-navyteal hover:bg-[#D18C2D] hover:text-navyteal rounded-full px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold cursor-pointer flex items-center justify-center gap-2 transition-all duration-200"
          >
