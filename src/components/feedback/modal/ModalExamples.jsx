    ...
    <div className="p-6 bg-gray-50 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow border">
          ...
          <p className="text-sm text-gray-600 mb-3">
            Opens a modal for purchasing packages with package details and pricing.
          </p>
          <button
        ...
        <div className="bg-white p-4 rounded-lg shadow border">
          ...
          <button
            onClick={() => openDetailsModal({
              ...
              description: "تهدف هذه المادة إلى تعريف الطالب بأساسيات الوقاية من الأمراض وأهمية اتباع أنماط الحياة الصحية السليمة."
            })}
        ...
        <div className="bg-white p-4 rounded-lg shadow border">
          ...
          <button
            onClick={() => openChangeGroupModal({
              currentGroupId: 2,
              groups: [
                { id: 1, name: "المجموعة 1", instructor: "أنيس", days: "الأحد | الثلاثاء", time: "5:00 مساءً", isCurrent: false },
                { id: 2, name: "المجموعة 2", instructor: "أنيس", days: "الأحد | الثلاثاء", time: "5:00 مساءً", isCurrent: true },
              ]
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <ol className="list-decimal list-inside space-y-1 text-sm text-blue-700">
          <li>Import the <code className="bg-blue-100 px-1 rounded">useModal</code> hook in your component</li>
