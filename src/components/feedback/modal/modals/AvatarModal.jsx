    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
      <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-xl relative">
        ...
        <div className="grid grid-cols-3 gap-6 place-items-center mt-6">
          ...
          {/* Upload Button */}
          <button className="w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center bg-amber-100 hover:bg-amber-200 rounded-full transition-all hover:cursor-pointer">
          <img
